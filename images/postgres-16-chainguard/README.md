...
docker build -t ghcr.io/<org>/postgres-16-chainguard:local images/postgres-16-chainguard
docker run --rm -e POSTGRES_PASSWORD=senha-forte -p 5432:5432 ghcr.io/<org>/postgres-16-chainguard:local
```
